...
class EventRegistrationPolicy
{
    ...
    {
        return $user->can('force_delete_event::registration');
    }
    ...
    {
        return $user->can('force_delete_any_event::registration');
    }
    ...
    {
        return $user->can('restore_event::registration');
    }
    ...
    {
        return $user->can('restore_any_event::registration');
    }
    ...
    {
        return $user->can('replicate_event::registration');
    }
    ...
    {
        return $user->can('reorder_event::registration');
    }
}
